...
public:
	...
	void TTAddEvent(SOCKET fd, uint8_t socket_event);
	void TTRemoveEvent(SOCKET fd, uint8_t socket_event);
    ...
    void StopDispatch();
    void ProcessEventsAndTimers(uint32_t wait_timeout = 100);
    
    bool isRunning() {return running;}
    //void CheckTimer() { this->_CheckTimer();};
