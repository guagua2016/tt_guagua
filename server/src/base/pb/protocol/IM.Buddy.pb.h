...
// optional uint32 app_id = 20;
inline bool IMRemoveSessionReq::has_app_id() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void IMRemoveSessionReq::set_has_app_id() {
  _has_bits_[0] |= 0x00000008u;
}
inline void IMRemoveSessionReq::clear_has_app_id() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void IMRemoveSessionReq::clear_app_id() {
  app_id_ = 0u;
  clear_has_app_id();
}
inline ::google::protobuf::uint32 IMRemoveSessionReq::app_id() const {
  // @@protoc_insertion_point(field_get:IM.Buddy.IMRemoveSessionReq.app_id)
  return app_id_;
}
inline void IMRemoveSessionReq::set_app_id(::google::protobuf::uint32 value) {
  set_has_app_id();
  app_id_ = value;
  // @@protoc_insertion_point(field_set:IM.Buddy.IMRemoveSessionReq.app_id)
}

// optional uint32 domain_id = 21;
inline bool IMRemoveSessionReq::has_domain_id() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void IMRemoveSessionReq::set_has_domain_id() {
  _has_bits_[0] |= 0x00000010u;
}
inline void IMRemoveSessionReq::clear_has_domain_id() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void IMRemoveSessionReq::clear_domain_id() {
  domain_id_ = 0u;
  clear_has_domain_id();
}
inline ::google::protobuf::uint32 IMRemoveSessionReq::domain_id() const {
  // @@protoc_insertion_point(field_get:IM.Buddy.IMRemoveSessionReq.domain_id)
  return domain_id_;
}
inline void IMRemoveSessionReq::set_domain_id(::google::protobuf::uint32 value) {
  set_has_domain_id();
  domain_id_ = value;
  // @@protoc_insertion_point(field_set:IM.Buddy.IMRemoveSessionReq.domain_id)
}
