...
const int IMRemoveSessionReq::kAppIdFieldNumber;
const int IMRemoveSessionReq::kDomainIdFieldNumber;
...
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<IMRemoveSessionReq*>(16)->f) - \
   reinterpret_cast<char*>(16))
