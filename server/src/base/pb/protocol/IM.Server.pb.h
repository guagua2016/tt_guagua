...
inline ::google::protobuf::uint32 IMValidateReq::user_id() const {
  // @@protoc_insertion_point(field_get:IM.Server.IMValidateReq.user_id)
  return user_id_;
}
inline void IMValidateReq::set_user_id(::google::protobuf::uint32 value) {
  set_has_user_id();
  user_id_ = value;
...
inline ::google::protobuf::uint32 IMValidateRsp::user_id() const {
  // @@protoc_insertion_point(field_get:IM.Server.IMValidateRsp.user_id)
  return user_id_;
}
inline void IMValidateRsp::set_user_id(::google::protobuf::uint32 value) {
  set_has_user_id();
  user_id_ = value;
