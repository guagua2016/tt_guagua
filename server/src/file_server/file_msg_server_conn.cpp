...
static rb_timer_item g_fileMsgServerConn_callback;
...
void InitializeFileMsgServerConn() {
	 rbtimer_init(&g_fileMsgServerConn_callback,FileMsgServerConnTimerCallback,NULL,1000,0,0);
	 netlib_register_timer(&g_fileMsgServerConn_callback, 1000);
