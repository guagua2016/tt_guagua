...
static rb_timer_item g_fileClientConnTimer_callback;
static rb_timer_item g_fileTaskTimer_callback;
...
void InitializeFileClientConn() {
    ...
    rbtimer_init(&g_fileClientConnTimer_callback,FileClientConnTimerCallback,NULL,1000,0,0);
    netlib_register_timer(&g_fileClientConnTimer_callback);

    rbtimer_init(&g_fileTaskTimer_callback,FileTaskTimerCallback,NULL,10000,0,0);
    netlib_register_timer(&g_fileTaskTimer_callback);
