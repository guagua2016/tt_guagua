...
static rb_timer_item  g_file_server_conn_timer;
...
void init_file_serv_conn(serv_info_t* server_list, uint32_t server_count)
{
	...
	rbtimer_init(&g_file_server_conn_timer,file_server_conn_timer_callback,NULL,1000,0,0);
	netlib_register_timer(&g_file_server_conn_timer);
