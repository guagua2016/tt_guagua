...
static rb_timer_item g_serverConn_timer;
...
void init_db_serv_conn(serv_info_t* server_list, uint32_t server_count, uint32_t concur_conn_cnt)
{
	...
	rbtimer_init(&g_serverConn_timer,db_server_conn_timer_callback,NULL,1000,0,0);
	netlib_register_timer(&g_serverConn_timer);
