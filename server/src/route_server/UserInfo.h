...
public:
    ...
    void AddClientType(uint32_t app_id, uint32_t domain_id);
    void RemoveClientType(uint32_t app_id, uint32_t domain_id);
    uint32_t GetCountByClientType(uint32_t app_id, uint32_t domain_id);
    bool IsMsgConnNULL();
